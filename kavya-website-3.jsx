...
function CursorGlow() {
  ...
  return (
    <div style={{
      ...
      background: `radial-gradient(600px circle at ${pos.x}px ${pos.y}px, rgba(207,175,115,0.04), transparent 60%)`
    }} />
  );
}
  ...
  return (
    <>
      <style>{`
        ...
        .nav-logo { font-family: 'Cormorant Garamond', serif; font-size: 22px; letter-spacing: 6px; color: #CFAF73; text-transform: uppercase; cursor: pointer; font-weight: 300; }
        ...
        @media (max-width: 900px) {
          ...
          .mobile-menu { display: ${menuOpen ? "flex" : "none"}; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(8,14,20,0.97); flex-direction: column; justify-content: center; align-items: center; gap: 32px; z-index: 999; }
          .mobile-menu button { font-family: 'Cormorant Garamond', serif; font-size: 28px; color: #EBE4DA; background: none; border: none; cursor: pointer; letter-spacing: 4px; }
...
function Hero() {
  ...
  return (
    <section ref={parallaxRef} style={{
      ...
      <div className="hero-ornament" style={{ top: 40, left: 40, width: 80, height: 80, borderRight: "none", borderBottom: "none" }} />
      <div className="hero-ornament" style={{ top: 40, right: 40, width: 80, height: 80, borderLeft: "none", borderBottom: "none" }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          Copywriting & Copyediting Studio
        </div>
  ...
  const services = [
    {
      ...
      desc: "Home page messaging, about pages with authenticity and purpose, service pages with clarity and persuasion, and calls-to-action that guide visitors forward.",
      icon: "✦"
    },
    {
      title: "Brand Messaging & Voice",
      subtitle: "The language of your identity",
      desc: "Brand voice and tone definition, core messaging pillars, audience-aligned positioning, and frameworks for consistent communication across every touchpoint.",
      icon: "◈"
    },
    {
      title: "Narrative & Voice Architecture",
      subtitle: "Deep strategic foundation",
      desc: "A comprehensive service that goes beyond individual copy—we define the story your brand tells, its emotional tone, language patterns, and narrative structures.",
      icon: "❖"
    },
    {
      title: "Marketing & Campaign Copy",
      subtitle: "Words that inspire action",
      desc: "Email campaigns, launch messaging, advertising copy, and sales-driven content—each crafted with strategic focus on clarity, persuasion, and audience connection.",
      icon: "✧"
    },
    {
      title: "Copyediting & Proofreading",
      subtitle: "Precision meets polish",
      desc: "Line editing, stylistic refinement, grammar correction, brand voice consistency, and academic or professional editing—preserving your voice while elevating your writing.",
      icon: "◇"
    },
    {
      title: "Website & App Development",
      subtitle: "Design that performs",
      desc: "Custom-built websites and applications crafted with the same intentionality we bring to language—elegant interfaces, seamless user experiences, and digital presence that converts.",
      icon: "⬡"
    }
  ];
  ...
  return (
    <section ref={ref} style={{
      ...
      <blockquote style={{
        ...
        Words should do more than fill space—they should <span style={{ color: "#CFAF73" }}>resonate</span>.
      </blockquote>
    </section>
  );
}
...
export default function KavyaWebsite() {
  return (
    <div style={{ background: "#080E14", color: "#EBE4DA", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,200;0,300;0,400;0,500;1,300;1,400&family=Montserrat:wght@300;400;500&display=swap');
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        html { scroll-behavior: smooth; }
        body { overflow-x: hidden; -webkit-font-smoothing: antialiased; }
        ::selection { background: rgba(207,175,115,0.3); color: #EBE4DA; }
      `}</style>
      <CursorGlow />
      <Nav />
      <Hero />
